    ...
    $.timeCube = function(el, options){
		...
		base.daysBetweenDates = function(date1, date2){
		    ...
		    return Math.round(difference_ms/ONE_DAY)
                ...
                base.map    = function(index){
                    var myLatlng = new google.maps.LatLng(base.options.data[index].lat,base.options.data[index].lang);
                    var mapOptions = {
                      zoom: 6,
                      center: myLatlng
                    }
                    ...
                    var marker = new google.maps.Marker({
                        position: myLatlng,
                        map: map,
                        title:"Earth Quake Effect"
                    }); 
                    
                    var html = '<div id="infobox">EarthQuake Magnitude on this area is '+ base.options.data[index].mag+'. </div>';
                    ...
                    var myOptions = {
                        ...
                        ,closeBoxMargin: "5px 6px 2px 6px"
